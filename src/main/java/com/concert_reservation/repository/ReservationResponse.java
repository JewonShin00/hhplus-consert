...
public class ReservationResponse {
  ...
  */
  ...
  @Schema(name = "reservationId", example = "res123", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  */
  ...
  @Schema(name = "status", example = "TEMP", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("status")
  ...
  */
  @Valid
  @Schema(name = "expiresAt", example = "2024-11-01T10:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
